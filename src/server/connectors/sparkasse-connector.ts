...
import { SparkasseStatementParser } from './parsers/sparkasse-parser';
...
export class SparkasseConnector extends BaseConnector {
  ...
  private statementParser: SparkasseStatementParser;

  constructor(connectorId: string) {
    super(connectorId);
    this.statementParser = new SparkasseStatementParser();
  }
  ...
  async fetchTransactions(
    ...
    try {
      ...
      // Parse statements
      const transactions = this.statementParser.parseStatements(response.statements || []);
